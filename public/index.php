...
<section class="section photo-section home-gallery-section">
    <div class="container photo-story">
        ...
        <div class="photo-mosaic reveal">
            <img class="photo-large" src="<?php echo htmlspecialchars(asset_url('img/imagens/721466374_18377040283202339_1097163294585383178_n.jpg')); ?>" loading="lazy" decoding="async" alt="Apresentação musical na AMORABI">
